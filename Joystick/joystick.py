        ...
        while True:
           ...
           #     science[1] = bool012(joystick[A_LEFT].get_button(10), joystick[A_LEFT].get_button(9)) - 1
              #  science[2] = bool012(joystick[A_LEFT].get_button(8), joystick[A_LEFT].get_button(7)) - 1
                ...
                hand[2] = float012(joystick[A_LEFT].get_axis(3) * -1)
                hand[1] = float012(joystick[A_LEFT].get_axis(1))
                hand[0] = float012(joystick[A_LEFT].get_axis(0))
                # bool012(joystick[A_LEFT].get_button(4), joystick[A_LEFT].get_button(2))
                hand[3] = bool012(joystick[A_LEFT].get_button(0), joystick[A_LEFT].get_button(1))

                misc[1] = bool012(joystick[A_RIGHT].get_button(6), joystick[A_RIGHT].get_button(7))
                misc[2] = bool012(joystick[A_RIGHT].get_button(0), joystick[A_RIGHT].get_button(1))
          ...
          #  scienceByte = chr(science[0] | (science[1] << 2) | (science[2] << 4))
            handByte = chr(hand[0] | (hand[1] << 2) | (hand[2] << 4) | (hand[3] << 6))
